...
public class TC_009_Select_a_Hotel extends AdactinHotel {
	
	@BeforeTest
	public void setUp() {
		sheetName="SelectAHotelValid";
	...
	public void selectAHotelToBook(String username, String password,String location, String hotel,String roomType, String noOfRooms,String checkInDate, String checkOutDate, String adultsPerRoom, String childrenPerRoom, String testType, String expectedResult) throws InterruptedException {
		...
		.clickSearchBtn().checkSearchedLocationName(location).checkSearchedHotelName(hotel).checkArrivalDate(checkInDate).checkDepartureDate(checkOutDate).selectRadioOption().selectContinue().checkSelectHotelValidation(testType, expectedResult);
		Thread.sleep(3000);
	}
